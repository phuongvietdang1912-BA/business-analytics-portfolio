...
> **TBD on completion. Candidate narratives from the data: weekday commuter patronage recovering more slowly than weekend leisure travel (the "missing Tuesday" effect); CBD stations lagging suburban stations; tram recovering faster than metro train.**
...
> *To be completed during analysis. Candidate areas:*
> - COVID trough depth and recovery % by mode (April 2020 vs latest)
> - Weekday vs weekend recovery divergence (work-from-home signal)
> - Station-level recovery leaders and laggards
> - Day-of-week recovery patterns (is mid-week lagging?)
